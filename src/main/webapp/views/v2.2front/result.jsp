...
<head>
    ...
    <!--手机不允许缩放-->
    <link rel="icon" href="/views/v2.2front/images/favicon.ico">
    <!--找不到这个可能是网站站点的图标-->
    <link rel="shortcut icon" href="images/favicon.ico"/>

    <link rel="stylesheet" href="/views/v2.2front/css/animation.css">
    <link rel="stylesheet" href="/views/v2.2front/css/camera.css">
    <link rel="stylesheet" href="/views/v2.2front/css/contact-form.css">
    <link rel="stylesheet" href="/views/v2.2front/css/touchTouch.css">
    <link rel="stylesheet" href="/views/v2.2front/css/style.css">

    <script src="/views/v2.2front/js/jquery.js"></script>
    <script src="/views/v2.2front/js/jquery-migrate-1.1.1.js"></script>
    <!--让你在原来代码上升级jquery 不用修改代码用的-->
    <script src="/views/v2.2front/js/jquery.easing.1.3.js"></script>
    <script src="/views/v2.2front/js/script.js"></script>
    <script src="/views/v2.2front/js/jquery.ui.totop.js"></script>
    <!--回到顶部的插件-->
    <script src="/views/v2.2front/js/touchTouch.jquery.js"></script>
    <script src="/views/v2.2front/js/isotope.pkgd.js"></script>
    <script src="/views/v2.2front/js/TMForm.js"></script>
    <script src="/views/v2.2front/js/modal.js"></script>
    <script src="/views/v2.2front/js/camera.js"></script>
    <!--[if (gt IE 9)|!(IE)]><!-->
    <script src="/views/v2.2front/js/jquery.mobile.customized.min.js"></script>
    <!--？？手机相关吧-->

    <!--bootstrap与登录框部分部分-->
    <link rel="stylesheet" href="/views/v2.2front/css/bootstrap.css"/>
    <!--这里有些奇怪？min与大的区别只有数据量的区别-->
    <link rel="stylesheet" href="/views/v2.2front/css/loging.css"/>
    ...
    <!--city城市控件-->
    <!-- -->
    <link rel="stylesheet" href="/views/v2.2front/css/city/cityStyle.css"/>
    <script type="text/javascript" src="/views/v2.2front/js/city/cityScript.js"></script>
    <script type="text/javascript" src="/views/v2.2front/js/city/lazyload-min.js"></script>
    <!-- -->
    <!--city   控件end-->

    <link rel="stylesheet" href="/views/v2.2front/css/myqd/index.css"/>

    <!--特殊result.css-------->
    <link rel="stylesheet" href="/views/v2.2front/css/myqd/result.css"/>
    <!--特殊result.css    end-->

    <!--图标库         -------->
    <link rel="stylesheet" href="/views/v2.2front/css/myqd/font-awesome.css"/>
    <!--图标库             end-->
                ...
                <div class="search-right">
                    ...
                    <div class="search-right-down floor-all">
                        <div class="floor">
                                <div class="flex-row">
                                    <div class="flex-3">
                                        <img src="/views/v2.2front/images/travel/xc-1-01.jpg" alt=""/>
                                    </div>
                        ...
                        <div class="floor">
                            <div class="flex-row">
                                <div class="flex-3">
                                    <img src="/views/v2.2front/images/result/${m.picture}" alt=""/>
                                </div>
                                <div class="flex-6 flex-col second">
                                    <div class="flex-6">
                                        <strong class="message"><a href="${m.url}">${m.name}</a></strong>
                                    </div>
                                    <div class="flex-6 flex-row">
...
<script src="/views/v2.2front/js/jquery.singlePageNav.min.js"></script>
<script>
...
<script src="/views/v2.2front/js/jquery.knob.js"></script>
<script>
    $(function ($) {
        $(".knob").knob({
...
<script src="/views/v2.2front/js/isotop_ini.js"></script>
</body>
</html>