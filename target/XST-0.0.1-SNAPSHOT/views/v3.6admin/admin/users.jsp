...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="users.jsp"><span class="fa fa-caret-right"></span> User List</a></li>
            ...
            <li ><a href="calendar.jsp"><span class="fa fa-caret-right"></span> Calendar</a></li>
    </ul></li>
    ...
    <li data-popover="true" data-content="Items in this group require a <strong><a href='http://portnine.com/bootstrap-themes/aircraft' target='blank'>premium license</a><strong>." rel="popover" data-placement="right"><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> Premium Features<i class="fa fa-collapse"></i></a></li>
        ...
        <li><ul class="accounts-menu nav nav-list collapse">
            <li ><a href="sign-in.jsp"><span class="fa fa-caret-right"></span> Sign In</a></li>
            <li ><a href="sign-up.jsp"><span class="fa fa-caret-right"></span> Sign Up</a></li>
        ...
        <li><a href="help.html" class="nav-header"><i class="fa fa-fw fa-question-circle"></i> Help</a></li>
            <li><a href="faq.jsp" class="nav-header"><i class="fa fa-fw fa-comment"></i> Faq</a></li>
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>the_mark7</td>
      <td>
          <a href="user.jsp"><i class="fa fa-pencil"></i></a>
